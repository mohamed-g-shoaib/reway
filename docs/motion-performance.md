# Animation performance guide | Motion
...
#### [Reduce layer size](#reduce-layer-size)
...
#### [Use alternative styles](#use-alternative-styles)
...
### [Accelerated values](#accelerated-values)
...
### [CSS variables and individual transforms](#css-variables-and-individual-transforms)
