                      ...
                      <label className="flex items-center justify-between gap-2 text-sm">
                        <span className="flex items-center gap-2">
                          <input
                            ...
                            onChange={() => handleToggleImportGroup(group.name)}
                          />
                          {group.name}
                        </span>
                  ...
                  <div className="space-y-1">
                    <div className="h-2 w-full rounded-full bg-muted">
                      <div
                        ...
                        style={{
                          width: `${importProgress.total === 0 ? 0 : Math.round((importProgress.processed / importProgress.total) * 100)}%`,
                        }}
                      />
                    </div>
                ...
                <li key={name}>
                  <label className="flex items-center gap-2 text-sm">
                    <input
                      ...
                      onChange={() => handleToggleExportGroup(name)}
                    />
                    {name}
                  </label>
                </li>
              ...
              <div className="space-y-1">
                <div className="h-2 w-full rounded-full bg-muted">
                  <div
                    className="h-2 rounded-full bg-primary transition-all"
                    style={{
                      width: `${exportProgress.total === 0 ? 0 : Math.round((exportProgress.processed / exportProgress.total) * 100)}%`,
                    }}
                  />
                </div>
                <div className="flex justify-between text-xs text-muted-foreground">
